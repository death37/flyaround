...
class User
{
     ...
     * Add assignation
     *
     * @param \WCS\CoavBundle\Entity\Flight $assignation
     *
     * @return User
     */
    public function addAssignation(\WCS\CoavBundle\Entity\Flight $assignation)
    {
     ...
     * @param \WCS\CoavBundle\Entity\Flight $assignation
     */
    public function removeAssignation(\WCS\CoavBundle\Entity\Flight $assignation)
    {
